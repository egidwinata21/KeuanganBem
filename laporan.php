...
<div class="wrapper">
        ...
        <div class="not-printed row justify-content-center">
        	<div class="col-lg-5 mr-4">
        		...
        		<form method="post">
        			...
        			<div class="form-group">
        				<button type="submit" name="btnLaporanPemasukkan" class="btn btn-primary">Laporan Pemasukkan Uang Kas</button>
        			</div>
        		</form>
        	</div>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2025 Bendahara Bem.</strong>
    All rights reserved.
